...
Для того, чтобы добавить новую ветку, используется команда:
...
и далее следовать внимательно следовать инструкции GitHub "чужой репозиторий" становится "своим" и уже его можно клонировать (git clone) себе на локальный